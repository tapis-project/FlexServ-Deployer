//! Deployment module for FlexServ.
//!
//! This module provides the core deployment abstractions and implementations for different backends:
//! - Pod-based deployment (Kubernetes/Tapis Pods)
//! - HPC-based deployment (batch jobs on HPC systems)
...
///
/// This trait defines the common interface for all deployment backends.
/// Implementations must provide methods for creating, starting, stopping,
/// terminating, and monitoring deployments.
